...
public class BaseMultiAppAdapter<T> extends BaseAppAdapter<BaseAdapterItem<T>,T> {

    private final SparseIntArray mItemLayoutIds;

    public BaseMultiAppAdapter() {
        super();
        this.mItemLayoutIds = new SparseIntArray();
    }

    public BaseMultiAppAdapter(@NonNull List<BaseAdapterItem<T>> adapterList) {
        super(adapterList);
        this.mItemLayoutIds = new SparseIntArray();
    }
