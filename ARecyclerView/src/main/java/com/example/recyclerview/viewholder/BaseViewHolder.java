...
public class BaseViewHolder<T> extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder<T> setText(@IdRes int viewId, String text) {
        TextView textView = findViewById(viewId);
        textView.setText(text);
        return this;
    }

    public BaseViewHolder<T> setText(@IdRes int viewId, @StringRes int stringResId) {
        TextView textView = findViewById(viewId);
        textView.setText(getContext().getString(stringResId));
        return this;
    }

    public BaseViewHolder<T> setText(@IdRes int viewId, @StringRes int stringResId, Object... formatArgs) {
        TextView textView = findViewById(viewId);
        textView.setText(getContext().getString(stringResId, formatArgs));
        return this;
    }

    public BaseViewHolder<T> setTextColorWithRes(@IdRes int viewId, @ColorRes int colorResId) {
        TextView textView = findViewById(viewId);
        textView.setTextColor(ContextCompat.getColor(getContext(), colorResId));
        return this;
    }

    public BaseViewHolder<T> setTextColorWithValue(@IdRes int viewId, @ColorInt int colorValue) {
        TextView textView = findViewById(viewId);
        textView.setTextColor(colorValue);
        return this;
    }

    public BaseViewHolder<T> setTextSizeWithRes(@IdRes int viewId, @DimenRes int dimensResId) {
        TextView textView = findViewById(viewId);
        textView.setTextSize(getContext().getResources().getDimension(dimensResId));
        return this;
    }

    public BaseViewHolder<T> setTextSizeWithValue(@IdRes int viewId, float textSizValue) {
        TextView textView = findViewById(viewId);
        textView.setTextSize(textSizValue);
        return this;
    }

    public BaseViewHolder<T> setTextSizeBySp(@IdRes int viewId, float spValue) {
        TextView textView = findViewById(viewId);
        textView.setTextSize(spToPx(spValue));
        return this;
    }

    public BaseViewHolder<T> setTextSizeByDp(@IdRes int viewId, float dpValue) {
        TextView textView = findViewById(viewId);
        textView.setTextSize(dpToPx(dpValue));
        return this;
    }

    public BaseViewHolder<T> setBackgroundResource(@IdRes int viewId, @DrawableRes int drawableResId) {
        View view = findViewById(viewId);
        view.setBackground(ContextCompat.getDrawable(getContext(), drawableResId));
        return this;
    }

    public BaseViewHolder<T> setBackgroundDrawable(@IdRes int viewId, Drawable drawable) {
        View view = findViewById(viewId);
        view.setBackground(drawable);
        return this;
    }

    public BaseViewHolder<T> setBackgroundColor(@IdRes int viewId, @ColorRes int colorResId) {
        View view = findViewById(viewId);
        view.setBackgroundColor(ContextCompat.getColor(getContext(), colorResId));
        return this;
    }

    public BaseViewHolder<T> setImageResource(@IdRes int viewId, @DrawableRes int drawableResId) {
